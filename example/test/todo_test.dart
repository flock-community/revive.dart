...
void main() {
  ...
  group('onTodoCompleted', () {
    testWidgets('both state and backend are updated', iphone8((tester) async {
      final $ = TestContext.fromData(todos: [todo]);

      await tester.pumpWidget(View($));
      await expectLater(find.byType(View), matchesGoldenFile('golden/onTodoCompleted/before_completed.png'));
      ...
      await tester.pumpWidget(View($));
      await expectLater(find.byType(View), matchesGoldenFile('golden/onTodoCompleted/after_completed.png'));
    }));
